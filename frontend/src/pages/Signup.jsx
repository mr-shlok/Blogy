            ...
            <div className="flex-1 flex items-center justify-center p-8 relative z-10">
                ...
                >
                    ...
                    <div className="bg-white border border-slate-100 rounded-[2.5rem] p-10 md:p-12 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
                        ...
                        <h2 className="text-4xl font-black mb-3 text-slate-900 tracking-tight">{t("nav.signup")}</h2>
                        <p className="text-slate-600 font-black mb-10 text-sm">{t("auth.signupSubtitle")}</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2.5">
                                <label className="text-[10px] font-black text-slate-600 uppercase tracking-widest ml-1">{t("auth.passwordLabel")}</label>
                                <div className="relative group">
                            ...
                            <div className="space-y-2.5">
                                <label className="text-[10px] font-black text-slate-600 uppercase tracking-widest ml-1">{t("auth.confirmPasswordLabel")}</label>
                                <div className="relative group">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-indigo-500 transition-colors" size={20} />
                                    <input
                                        type="password"
                            ...
                            >
                                {loading ? <Loader2 className="animate-spin" size={20} /> : <span className="uppercase tracking-widest text-sm">{t("nav.signup")}</span>}
                            </button>
                        </form>
                        ...
                        <div className="relative my-10">
                            ...
                            <div className="relative flex justify-center text-[10px]">
                                <span className="px-5 bg-white text-slate-400 font-black uppercase tracking-[0.3em]">{t("auth.joinMovement")}</span>
                            </div>
                        </div>
