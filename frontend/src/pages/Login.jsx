            ...
            <div className="flex-1 flex items-center justify-center p-8 relative z-10">
                ...
                >
                    ...
                    <div className="bg-white border border-slate-200 rounded-[2rem] p-10 md:p-12 shadow-2xl shadow-slate-200/40 relative overflow-hidden">
                        ...
                        <h2 className="text-3xl font-extrabold mb-2 text-slate-900 tracking-tight">{t("nav.login")}</h2>
                        <p className="text-slate-500 font-medium mb-10 text-sm">{t("auth.welcomeBack")}</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center ml-1">
                                    <label className="text-[11px] font-bold text-slate-500 uppercase tracking-widest">{t("auth.passwordLabel")}</label>
                                    <span className="text-[11px] font-bold text-indigo-600 uppercase tracking-widest cursor-pointer hover:text-indigo-700 transition-all">{t("auth.forgotPassword")}</span>
                                </div>
                                <div className="relative group">
                            ...
                            >
                                {loading ? <Loader2 className="animate-spin" size={20} /> : <span className="uppercase tracking-widest text-xs">{t("nav.login")}</span>}
                            </button>
                        </form>
                        ...
                        <div className="relative my-10">
                            ...
                            <div className="relative flex justify-center text-[10px]">
                                <span className="px-5 bg-white text-slate-400 font-bold uppercase tracking-[0.2em]">{t("auth.secureAccess")}</span>
                            </div>
                        </div>
